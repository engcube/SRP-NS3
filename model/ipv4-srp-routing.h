...
/**
 * \brief Add a host route to the SRP routing table.
 *
...
/**
 * \brief Add a network route to the SRP routing table.
 *
...
/**
 * \brief Add an external route to the SRP routing table.
 *
 * \param network The Ipv4Address network for this route.
 * \param networkMask The Ipv4Mask to extract the network.
...
/**
 * \brief Get a route from the SRP unicast routing table.
 *
 * Externally, the unicast SRP routing table appears simply as a table with
 ...
 * \see Ipv4SRPRouting::RemoveRoute
 */
  Ipv4RoutingTableEntry *GetRoute (uint32_t i) const;

/**
 * \brief Remove a route from the SRP unicast routing table.
 *
 * Externally, the unicast SRP routing table appears simply as a table with
 * n entries.  The one subtlety of note is that if a default route has been set
 ...
 *
 * \see Ipv4RoutingTableEntry
 * \see Ipv4SRPRouting::GetRoute
 * \see Ipv4SRPRouting::AddRoute
 */
